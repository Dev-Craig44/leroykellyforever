        ...
        >
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-zinc-200 rounded-xl shadow-inner focus:outline-none focus:ring-2 focus:ring-zinc-300 focus:shadow-md transition-all duration-200 hover:border-zinc-300"
              autoFocus
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full px-6 py-3 rounded-xl bg-black text-white font-semibold hover:bg-zinc-800 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5 active:scale-[0.98]"
          >
            Login
          </button>
